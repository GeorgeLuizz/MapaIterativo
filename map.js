...
const buttonsState = [buttonInfoPA]

buttonsState.forEach(buttonState => {
    map.innerHTML += buttonState.html
    const buttonContainer = document.getElementById(buttonState.id + '-button-container')
    console.log(buttonContainer)
    tippy('#' + buttonState.id, {
        onShow: () => {
